...
#language,.navbar-static-top,#column-left{
   display:none !important;
}
.eventdate{
  width:200px;
...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1>Create Hall/Space</h1>
<input type="hidden" name="kabeer"/>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i>  create Hall/Space</h3>
      </div>
      <div class="panel-body">
        <form action="<?php echo  str_replace('product','event',$action);?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li  class="hidden"  ><a href="#tab-image" data-toggle="tab"> Event Banner Images</a></li>
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>">Hall/Space Name</label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" placeholder="Please Enter Hall/Event Name " id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
              ...
              <div class="table-responsive">
               ...
               <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-upc"><span >Projector /Speaker /Mic Available ?</span></label>
                   ...
                   <div class="col-sm-10">
                             <label class="switch">
                            <input class="venue-type"type="checkbox">
                            <span class="slider round"></span>
                              </label>
                 </div>
            ...
            <div class="form-group hidden venue-details-part location-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="Venue /Hall Details" value="<?php echo $sku; ?>" placeholder="latt" id="input-sku" class="form-control" />
                </div>
              </div>
              ...
              <div class="hidden form-group required">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Principal Name</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="princiname" value="<?php echo $princiname; ?>" placeholder="Principal Name" id="input-princiname" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group  required hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Vision Statement</span></label>
                <div class="col-sm-10">
                  
                 
                  <textarea class="form-control" name="visionst" placeholder="Vision Statement" id="input-visionst" value=""><?php echo $visionst; ?></textarea>
                </div>
                </div>
                <div class="form-group  required hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Name 1</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="rolename1" value="<?php echo $rolename1; ?>" placeholder="Role Name 1" id="input-rolename1" class="form-control" />
                </div>
              </div>
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Message 1</span></label>
                <div class="col-sm-10">
                  
                  <textarea class="form-control" name="rolemsg1" placeholder="Role Message 1" id="input-rolemsg1" value=""><?php echo $rolemsg1; ?></textarea>
                </div>
              </div>
              <div class="form-group  required hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Image URL 1</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="imageUrl1" value="<?php echo $imageUrl1; ?>" placeholder="Image URL 1" id="input-imageUrl1" class="form-control" />
                </div>
              </div>
              
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Name 2</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="rolename2" value="<?php echo $rolename2; ?>" placeholder="Role Name 2" id="input-rolename2" class="form-control" />
                </div>
              </div>
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Message 2</span></label>
                <div class="col-sm-10">
                  
                  <textarea class="form-control" name="rolemsg2" placeholder="Role Message 2" id="input-rolemsg2" value=""><?php echo $rolemsg2; ?></textarea>
                </div>
              </div>
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Image URL 2</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="imageUrl2" value="<?php echo $imageUrl2; ?>" placeholder="Image URL 2" id="input-imageUrl2" class="form-control" />
                </div>
              </div>
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Name 3</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="rolename3" value="<?php echo $rolename3; ?>" placeholder="Role Name 3" id="input-rolename3" class="form-control" />
                </div>
              </div>
              
              <div class="form-group hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Role Message 3</span></label>
                <div class="col-sm-10">
                  
                  <textarea class="form-control" name="rolemsg3" placeholder="Role Message 3" id="input-rolemsg3" value=""><?php echo $rolemsg3; ?></textarea>
                </div>
              </div>
              <div class="form-group  required hidden">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="">Image URL 3</span></label>
                <div class="col-sm-10">
                  
                  <input type="text" name="imageUrl3" value="<?php echo $imageUrl3; ?>" placeholder="Image URL 3" id="input-imageUrl3" class="form-control" />
                </div>
              </div>
