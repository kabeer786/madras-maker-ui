...
$(document).ready(function(){
    ...
    $("#input-ean").on('keypress',function(){
        console.log('keypress')
    
    $("#input-location").val($(this).val());
})
})
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="hidden navbar-brand"><img src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
