	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/techone&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
				...
				<div class="bg-tabs">
					...
					<div id="tab_general" class="tab-content2">
						...
						<div id="tab_header" class="tab-content">
							...
							<div class="input with-status">
								<p style="width:270px">Always show vertical menu on home:</p>
								<?php if($always_show_vertical_menu_on_home == 0) { echo '<div class="status status-off" title="0" rel="always_show_vertical_menu_on_home"></div>'; } else { echo '<div class="status status-on" title="1" rel="always_show_vertical_menu_on_home"></div>'; } ?>
								<input name="always_show_vertical_menu_on_home" value="<?php echo $always_show_vertical_menu_on_home; ?>" id="always_show_vertical_menu_on_home" type="hidden" />
								<div class="clear"></div>
							</div>
					...
					<div id="tab_design" class="tab-content2">
						...
						<div id="tab_colors" class="tab-content">
							...
							<div class="input" style="border: none">
								...
								<p>Dark version status:</p>
								<select name="dark_status">
									<option value="0"<?php if($dark_status < 1) { echo ' selected="selected"'; } ?>>Disabled</option>
									<option value="1"<?php if($dark_status == 1) { echo ' selected="selected"'; } ?>>Enabled</option>
								</select>
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input" style="border: none">
							...
							<select name="select_demo" id="select_demo">
							     ...
							     <option value="2" <?php if($select_demo == '2'){echo ' selected="selected"';} ?>>electronics</option>
							     <option value="3" <?php if($select_demo == '3'){echo ' selected="selected"';} ?>>digital</option>
							     <option value="4" <?php if($select_demo == '4'){echo ' selected="selected"';} ?>>digital green</option>
							     <option value="5" <?php if($select_demo == '5'){echo ' selected="selected"';} ?>>dark version</option>
							     <option value="6" <?php if($select_demo == '6'){echo ' selected="selected"';} ?>>digital red</option>
							     <option value="7" <?php if($select_demo == '7'){echo ' selected="selected"';} ?>>digital yellow</option>
							</select>
						...
						<div class="input versions version-1 version-2 version-3 version-4 version-5 version-6 version-7">
						...
						<div class="input versions version-2 version-3 version-4 version-6 version-7" style="display: none">
						...
						<div class="input versions version-1 version-2 version-3 version-4 version-5 version-6 version-7">
							<p style="width:240px">Blog latest posts:</p>
							<input type="submit" name="install_blog_latest" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input versions version-1 version-2 version-3 version-4 version-6 version-7">
