...
<span class="phone">(080)123 4567 891</span>
  ...
  array (
	...
	<div class="col-sm-6"><a href="#"><img src="image/catalog/version3/banner_01.jpg" alt=""></a></div>
	<div class="col-sm-6"><a href="#"><img src="image/catalog/version3/banner_02.jpg" alt=""></a></div>
</div>',
...
--></script>',
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div style="height: 485px" class="hidden-xs hidden-sm"></div>',
      1 => '<div style="height: 485px" class="hidden-xs hidden-sm"></div>',
    ),
    'layout_id' => '1',
    'position' => 'column_left',
    'status' => '1',
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="row techone-iconbox2">
	<div class="col-sm-4">
		<div class="iconbox2">
			<div class="icon"><span class="fa fa-truck"></span></div>
			<div class="content">
				<h3 class="title">Free Shipping &amp; Return</h3>
				<div class="text">Free shipping on all oders over $100</div>
			</div>
		</div>
	</div>
	...
	<div class="col-sm-4">
		<div class="iconbox2">
			<div class="icon"><span class="fa fa-retweet"></span></div>
			<div class="content">
	...
	<div class="col-sm-4">
		<div class="iconbox2">
			...
			<div class="content">
				...
				<div class="text">Online support 24/7</div>
			</div>
		</div>
	</div>
</div>',
      1 => '<div class="row techone-iconbox2">
	<div class="col-sm-4">
		<div class="iconbox2">
			<div class="icon"><span class="fa fa-truck"></span></div>
			<div class="content">
